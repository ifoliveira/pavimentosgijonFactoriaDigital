...
final class TicketController extends AbstractController
{
    ...
    public function index(
        ...
        return $this->render('admin_pro/ticket/index.html.twig', [
            'tickets' => $tickets,
            'resumen' => $resumen,
            'anio' => $anio,
            'trimestre' => $trimestre,
    ...
    #[Route('/{id}/pdf',name: 'admin_ticket_pdf',methods: ['GET'])]
    ...
    #[Route('/pdf-trimestre/{anio}/{trimestre}',name: 'admin_ticket_pdf_trimestre',methods: ['GET'])]
    ...
    #[Route('/resumen/{anio}/{trimestre}/pdf',name: 'admin_ticket_resumen_pdf', methods: ['GET'])]
    ...
    #[Route('/resumen/{anio}/{trimestre}/csv',name: 'admin_ticket_resumen_csv',methods: ['GET'])]
