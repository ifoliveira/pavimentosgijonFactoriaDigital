...
//
        ...
        $publicDirectory =  'Presupuestos' . '/' . $presupuesto->getClientePe()->getNombreCl() . ' ' . $presupuesto->getFechainiPe()->format('Y-m-d') .'/presupuestos';
        ...
        $pdfFilepath = '../public/' . $publicDirectory . '/'. $namepdf . '.pdf';
