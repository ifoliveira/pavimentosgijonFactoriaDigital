 ...
 */
final class Version20220102225108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE presupuestos ADD importemanoobra DOUBLE PRECISION DEFAULT NULL');
