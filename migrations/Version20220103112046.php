 ...
 */
final class Version20220103112046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cestas ADD prespuesto_cs_id INT DEFAULT NULL, CHANGE tipopago_cs tipopago_cs VARCHAR(15) NOT NULL, CHANGE numticket_cs numticket_cs VARCHAR(55) NOT NULL');
        $this->addSql('ALTER TABLE cestas ADD CONSTRAINT FK_F1E891F451BC2A97 FOREIGN KEY (prespuesto_cs_id) REFERENCES presupuestos (id)');
        $this->addSql('ALTER TABLE presupuestos DROP Ticketsnal');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F1E891F451BC2A97 ON cestas');
        $this->addSql('ALTER TABLE cestas DROP prespuesto_cs_id, CHANGE tipopago_cs tipopago_cs VARCHAR(15) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE numticket_cs numticket_cs VARCHAR(55) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`');
        ...
        $this->addSql('ALTER TABLE efectivo DROP INDEX primary, ADD INDEX efectivo_id_IDX (id)');
        ...
        $this->addSql('ALTER TABLE efectivo CHANGE concepto_ef concepto_ef VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`');
